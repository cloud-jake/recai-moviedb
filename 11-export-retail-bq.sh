...
echo ""
echo "In the Events Table box, enter the project, dataset, and table IDs of the user event table that you exported to BigQuery. The format is ${PROJECT_ID}:${EXPORT_DATASET}.${EXPORT_PREFIX}_retail_user_events"
echo ""
echo "In the Products Table box, enter the project, dataset, and table IDs of the Retail product table that you exported to BigQuery. The format is ${PROJECT_ID}:${EXPORT_DATASET}.${EXPORT_PREFIX}_retail_products"
echo ""
echo "In the Sales Materialized View box, enter the project, dataset, and table IDs of the materialized view for sales that you created in Create a materialized view for sales. The format is ${PROJECT_ID}:${EXPORT_DATASET}.mv_sales"